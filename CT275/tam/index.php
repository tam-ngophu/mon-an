...
<div class="container backgroudnencontainer">
  ...
  <div class="row mt-4">
    <!-- điện thoai samsung-->
    <div class="col-md-10">
    <b style="color: red; font-size: 20px;"><i class="fa fa-star-o" aria-hidden="true"></i> Samsung <i class="fa fa-star-o" aria-hidden="true"></i></b>
    <?php
        $conn = mysqli_connect("localhost", "root", "","qlbanhang");
        $sql ="select * from dienthoai where MNDT like '%SS%'";
        $result = mysqli_query($conn,$sql);
        $i =1;
    ...
    <div class="col-md-2  banchay1">
      ...
      <?php
      $conn = mysqli_connect("localhost", "root", "","qlbanhang");
      $sql ="select * from dienthoai where MSDT='IP1' or MSDT='OP1' or MSDT='SS3'";
      $result = mysqli_query($conn,$sql);
      while($row = mysqli_fetch_array($result)){
      echo"<table>";
      echo"<tr>";
    ...
    <?php
        $conn = mysqli_connect("localhost", "root", "","qlbanhang");
        $sql ="select * from dienthoai where MNDT like '%IP%'";
        $result = mysqli_query($conn,$sql);
        $i =1;
        while($row = mysqli_fetch_array($result)){
          if($i>4) break;
          echo "<div class='col mt-3'>";
            echo"<div class='card float-left' style='width: 13.9rem; height: 25rem;'>";
             echo"<img src='".$row["HinhAnh"]."' class='img-fluid'>";
    ...
    <!-- điện thoại oppo -->
    <div class="col-md-10 mt-4">
    <b style="color: red; font-size: 20px;"><i class="fa fa-star-o" aria-hidden="true"></i> Oppo <i class="fa fa-star-o" aria-hidden="true"></i></b>

    <?php
        $conn = mysqli_connect("localhost", "root", "","qlbanhang");
        $sql ="select * from dienthoai where MNDT like '%OP%'";
        $result = mysqli_query($conn,$sql);
        $i =1;
        while($row = mysqli_fetch_array($result)){
          if($i>4) break;
