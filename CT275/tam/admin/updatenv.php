                    ...
                    <div class="col-md-12 mx-auto">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <h1 style="color: red;">Cập nhật thông tin</h1>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col">
                                <div class="form-group row" style="margin-top: 22px">
                                    <label for="MNDT" class="col-sm-2 col-form-label">MSNV</label>
                        ...
                        <div class="form-row">
                            <div class="col">
                                <div class="form-group row" style="margin-left: 230px">
                                    <button type="submit" name="updatenv" id="updatenv" class="btn btn-outline-primary">Lưu</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
if(isset($_POST['updatenv'])){
    ...
    $GioiTinhNV=$_POST['rdGioitinh'];
    $NgaySinhNV=$_POST['dateNS'];
    $emailNV=$_POST['E-mail'];
    $CMNDNV=$_POST['txtCMND'];
    $ChucVu=$_POST['txtChucvu'];
    $DiaChiNV=$_POST['txtDiachi'];
...
function test(){
    ...
    if(document.getElementById("inputPassword1").value ==""){
        document.getElementById("loi3").innerHTML="Vui lòng nhập password!";check=false;
    }else if(document.getElementById("inputPassword1").length < 3){
        document.getElementById("loi3").innerHTML="Vui lòng nhập Họ tên ít nhất 3 ký tự!";check=false;
    }else {
    ...
    if(document.getElementById("inputPassword2").value =="" && document.getElementById("inputPassword1").value !=""){
        document.getElementById("loi4").innerHTML="Vui lòng nhập lại password!";check=false;
    }else if(document.getElementById("inputPassword2").value =="" && document.getElementById("inputPassword1").value ==""){
        document.getElementById("loi4").innerHTML="";check=false;
    }else if(document.getElementById("inputPassword2").value != document.getElementById("inputPassword1").value){
        document.getElementById("loi4").innerHTML="Vui lòng nhập password giống như trên!";check=false;
    }else {
    ...
    if(ktraemail(email)){
        ...
        document.getElementById("loi5").innerHTML="Vui lòng nhập email";
    }else{
        document.getElementById("loi5").innerHTML="Vui lòng nhập email đúng dạng abc@gmail.com";
    }
    if(check==true){
        alert("Cập nhật thông tin thành công");
    }else{
        alert("Cập nhật không thành công, vui lòng kiểm tra lổi của bạn");
    }
    return check;
