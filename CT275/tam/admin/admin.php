        ...
        <div class="col-md-12">
            <table class="table table-success table-striped">
                ...
                <tbody>
                    ...
                    <td><?=$value['GiaDDH'];?> VNĐ</td>
                    <td><?=$value['MSKH'];?></td>
                    <td><?=$value['NgayDH'];?></td>
                    <td><img src="../<?=$value['HinhAnh'];?>" class="img"/></td>
                    <td><input type='checkbox' name='MSD[]' id="<?=$value['MSDDT'];?>" value=<?=$value['MSDDT'];?>/>
                      <?php
            ...
            <button type="submit" name="duyet" class="btn btn-primary">Duyệt đơn hàng</button>
        </div>
        <?php echo"</form>"; ?>
    </div>
</div>
